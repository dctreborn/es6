...
class Panel extends Component {
  ...
  render() {
    let show = this.state.selected.value;
    let text;
    switch (show) {
      case "SHOW_LOREM":
          text = "testtestsetsteststests";
        break;
      case "SHOW_CAT":
          text = <img src='https://www.petfinder.com/wp-content/uploads/2012/11/91615172-find-a-lump-on-cats-skin-632x475.jpg' alt='cat'/>;
        break;
      case "SHOW_NOTHING":
          text = "";
        break;
